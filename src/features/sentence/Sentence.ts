...
export const SENTENCES_TEMPLATES: SentenceTemplate[] = [
  ...
  {
    sentence:
      "{2,pronoun} {3,verb,*haben,![2]} {1,article,!link(akk|0)} {0,noun,~relative}",
    tags: [],
  },
  {
    sentence:
      "{3,article,!link(nom|2)} {2,noun,~relative} {4,verb,*haben,!link(2)} {1,article,!link(akk|0)} {0,noun,~animal}",
    tags: [],
  },
];
